...
pub fn run() {
    use commands::{
        ...
        server::{
            server_create, server_delete, server_get_active, server_get_active_config,
            server_get_all, server_is_active, server_load, server_unload,
        },
